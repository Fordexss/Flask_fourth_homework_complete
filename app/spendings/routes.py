...
def create_spending():
    if request.method == 'GET':
        ...
        return render_template('spendings/register.html', categories=categories)
    else:
...
def get_spendings():
    ...
    for spending in spendings:
        spendings_dict.append({
            ...
            # Змінено на отримання імені категорії
            "date": spending['date'],
...
def edit_spending(spending_id):
    ...
    categories = get_category_db().get_categories()
    return render_template('spendings/edit_spending.html', spending=spending, categories=categories)
